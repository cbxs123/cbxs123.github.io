...
> 正所谓前人栽树，后人乘凉。
> 
> 感谢[Huxpro](https://github.com/huxpro)&[Saili](http://saili.science/2017/04/02/github-for-win/#h5palyer)提供的博客模板
> 
...
#### 网站人数统计([参考](https://sunbossrs.github.io/2019/01/11/Self_WebsiteTotal.html))
...
这里比较麻烦。。。因为指定了文件。请点击这个按钮，下载文件（svg包）
<a class="btn" href='https://coding.net/u/SunbossRS/p/GotBlogDowner/git/raw/master/filedown/Wangzhantongji_svg.zip'>点击这里</a>
解压后看见assets文件夹，把assets文件夹放到网站的目录下，OK了。 
